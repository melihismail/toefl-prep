// Vendored from React Bits — https://reactbits.dev/backgrounds/color-bends
// (DavidHDev/react-bits, src/ts-default/Backgrounds/ColorBends).
//
// One local change: the pointer listener is on window rather than the
// container. The background sits behind the page with pointer-events: none so
// the nav and cards stay clickable, and a container that cannot receive
// pointer events never fires pointermove.
