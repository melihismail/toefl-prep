// Vendored from React Bits — a specular sheen that travels around the button's
// border. Two local changes, both marked below:
//   1. the drop shadow is a CSS variable, because the original is tuned for a
//      dark page and this site's landing is light;
//   2. `fullWidth`, so it can sit in the landing card stack at the same width
//      as the cards beneath it.
...
export interface SpecularButtonProps {
  ...
  /** Local addition: stretch to the container, for a stacked call to action. */
  fullWidth?: boolean;
  /** Local addition: the original shadow assumes a dark page. */
  shadow?: string;
  'aria-label'?: string;
}
...
const SpecularButton = ({
  ...
  type = 'button',
  fullWidth = false,
  shadow = 'inset 0 1px 0 rgba(255,255,255,0.04), 0 8px 24px rgba(0,0,0,0.25)',
