  ...
  return (
    <div className="landing">
      ...
      <div className="landing-cards">
        {/* Practising is what people come here to do, so it leads. Same card as
            the other, just marked as the primary one. */}
        <Link className="landing-card is-primary" to="/sections">
